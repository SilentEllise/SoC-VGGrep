...
#widen_zrt_wires
#report_critical_area -fault_type open
#SHFILL2_RVT SHFILL3_RVT SHFILL64_RVT SHFILL128_RVT
#insert_stdcell_filler -cell_without_metal {SHFILL1_RVT} -connect_to_power VDD -connect_to_ground VSS
